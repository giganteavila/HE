...
Figura 21. Pirémide de informacién.
...
Datalux/Osintgram) que permite recolectar informacién de un usuario a través
...
de linea de comands. La informacién se puede obtener de cuentas pUblicas o
de cuentas a las que se sigue. La Figura 2.29 muestra el error que ocurre al tratar
de recopllar informacién de una cuenta a la que no se esté siguiendo,
...
dificil obtener informacién relevante a partir de un numero. Ademas, depende en
...
github.com/sundowndev/phoneinfoga), que permite obtener informacién del
...
do en Medium donde el autor explica el proceso de creacién de la herramienta y
...
Una fuga de informacién, fltracion o leak es la publicaci6n de datos confiden-
...
vvés de Chelsea Manning, Estos documentos incluian informacién de las guerras
...
No todos los sitios web donde se publican fugas de informacién tienen un caréc~
...
mientas més comunes para realizar busquedas de informacién en leaks.
...
cha de informacién. El sitio rastrea las brechas de seguridad que se han pro-
...
modo que la informacién recolectada esté agrupada en un mismo lugar. Asi,
...
La opcién info permite obtener mas informacién de un médulo determinado;
...
Para obtener informacién completa del médulo cargado esté el comando info.
...
informacién relacionada con las direcciones IP almacenadas en el espacio de
...
En la informacién mostrada para los distintos médulos (marketplace info <mé-
...
Gestion de lo informacién obtenida por los médulos
...
») La pagina web de tu centro educative donde se ofrece informacién de
...
26. gAdénde te debes dirigit para obtener informacién de un dominio .es?
...
2.9. Qué informacién se puede obtener con DNS Cache Snooping?
...
‘Antes de comenzar la recogida de informacién es necesario valorar el es-
tado actual de tu privacidad, tanto en los equipos informaticos que usas
como en Ia informacién personal que puede encontrarse publicamente.
...
ra anénima y segura. £1 punto de partida inicial de esta actividad deberia
...
tu trabajo de forma anénima y segura. Para ello, se recomienda consultar
...
2. Reconocimiento DNS: resumen organizado de la informacién obtenida
   en la tarea anterior y la nueva informacién que puedas obtener a tra-
...
218. Emplea recon-ng para recopilar informacién de un dominio de internet de
     tueleccién.
